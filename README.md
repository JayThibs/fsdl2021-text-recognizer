...
This repository is meant for playing around with the Text Recognizer from the Full Stack Deep Learning course [labs](https://github.com/full-stack-deep-learning/fsdl-text-recognizer-2021-labs). If I end up working to extend upon the project, I will create a separate repository.
